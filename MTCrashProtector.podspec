#
#  Be sure to run `pod spec lint MTCrashProtector.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "kuangjeon" => "tgq@meitu.com" }
  # Or just: s.author    = "kuangjeon"
  # s.authors            = { "kuangjeon" => "tgq@meitu.com" }
  # s.social_media_url   = "http://twitter.com/kuangjeon"
...
#  s.public_header_files = "Classes/MTCrashProtector.h"
  ...
  # s.dependency "Crashlytics", "~> 3.10.1"
